    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_gender', models.CharField(default=None, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='meto_user_app.booking')),
            ],
        ),
        migrations.AddField(
            model_name='booking',
        ...
        migrations.AddField(
            model_name='booking',
            name='staff_id',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='staff', to='meto_admin_app.staff'),
        ),
        migrations.AddField(
            model_name='booking',
            name='user_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user', to='meto_user_app.user'),
        ),
        migrations.AddField(
            model_name='booking',
            name='worker_id',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='worker', to='meto_admin_app.worker'),
        ),
    ]
